                        ...
                        <div class="card-body">
                            <form action="{{ route('factories.store') }}" method="post">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-6">
                                      <input type="text" class="form-control @error('factory_name') is-invalid @enderror" id="factory_name" name="factory_name" value="{{ old('factory_name') }}">
                                ...
                                <div class="mb-3 row">
                                    <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Add Factory">
                                </div>
